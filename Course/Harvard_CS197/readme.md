...
- Official Notes: https://docs.google.com/document/d/18mTeEk1zfJDz-oY48oB96ryZRuiAWRbCLOMYKap8eXk/edit# 
- Summary: This lecture will guild you to fine-tune a language model through Huggingface. There are three parts: dataset loading, tokenization, and fine-tuning. *Because building is the most way of learning AI/ML engineering and Huggingface is the most popular hub for AI/ML researchers/engineers, I highly recommend you go through the official documentation of Huggingface in advance.* For your convenience, I attached [my notes for HuggingFace]() here. 
